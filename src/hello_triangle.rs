...
impl Runner for HelloTriangle {
    ...
    fn run(&self) {
        ...
        let (mut shader_program, mut VAO) = unsafe {
            ...
            if success != gl::TRUE as GLint {
                gl::GetShaderInfoLog(vertex_shader, 512, ptr::null_mut(), infoLog.as_mut_ptr() as *mut gl::types::GLchar);
            ...
            if success != gl::TRUE as GLint {
                gl::GetShaderInfoLog(fragment_shader, 512, ptr::null_mut(), infoLog.as_mut_ptr() as *mut gl::types::GLchar);
            ...
            if success != gl::TRUE as GLint {
                gl::GetProgramInfoLog(shader_program, 512, ptr::null_mut(), infoLog.as_mut_ptr() as *mut gl::types::GLchar);
